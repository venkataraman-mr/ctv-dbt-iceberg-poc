...
-- created_timestamp is TIMESTAMP(6) WITHOUT zone (UTC wall-clock), matching the reference-sync
-- convention; the Arrow schema the landing appends must match these types exactly.
