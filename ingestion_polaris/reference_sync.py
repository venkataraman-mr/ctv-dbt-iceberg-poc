...
Thin config over the shared engine (ingestion_polaris/common/ref_sync_engine.py). The engine holds all the
...
Usage:
  python -m ingestion_polaris.reference_sync                    # all tables (daily cron)
  python -m ingestion_polaris.reference_sync --table origin     # one table
  REF_SYNC_BATCH_ROWS=500000 python -m ingestion_polaris.reference_sync   # tune batch size
"""
import argparse
import sys
