...
IDENTICAL to the hive_metastore sync (ingestion_polaris/reference_sync.py) — same shared engine
(ingestion_polaris/common/ref_sync_engine.py), same streaming + atomic reload + normalization. The ONLY
...
Usage:
  python -m ingestion_polaris.uc_reference_sync                          # all UC reference tables
  python -m ingestion_polaris.uc_reference_sync --table creative_match_type
"""
import argparse
import sys

from ingestion_polaris import config
from ingestion_polaris.common import ref_sync_engine as engine
from ingestion_polaris.common.catalog import get_catalog
