...
{%- set uu = 'polaris.bronze.creative_unique_urls' -%}
{%- set tmp_pg = 'tempwork.tmp_digital_raw_occ_to_crtv_firstseen_ctv_poc_pol' -%}
...
from {{ self_rel }}
{%- endset -%}
{%- set h_call = pg_call("call tempwork.sp_dbx_digital_update_raw_occ_to_crtv_first_seen_ctv_poc_pol('" ~ tmp_pg ~ "')") -%}
