{#
  ...
  POLARIS: identical to Nessie -- pure ref()/source(); secondary_products arrives as VARCHAR json from
  crtv_product_resync_affected (which down-casts the gold VARIANT), so json_parse works unchanged. The rebuilt
  new_vx1/vx2_secondary_products stay VARCHAR json here; crtv_product_resync CASTs them to variant at the gold write.
#}
