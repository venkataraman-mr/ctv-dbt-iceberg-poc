{#
  ...
  rows from polaris.silver.creative_dedupe_map by child_creative_id.
  ...
  creative_ctv_poc_pol.creative_id.

  Prereq (once): seed CTV_SYNC_DEDUP_DELETE (ddl/polaris/08).
...
{%- set crtv = source('tempwork', 'creative_ctv_poc_pol') -%}
{%- set dm   = source('tempwork', 'creative_dedupe_map_ctv_poc_pol') -%}
