{#
  ...
  POLARIS: identical to Nessie -- pure ref()/source(); secondary_products arrives as VARCHAR json (crtv_product_resync_affected
  down-casts the gold VARIANT column back to VARCHAR), so json_parse works unchanged. No variant/smallint edits here.
#}
